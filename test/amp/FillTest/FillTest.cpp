...
//);
//BOLT_TEMPLATE_REGISTER_NEW_ITERATOR( bolt::amp::device_vector, int, samp);
...
//class HostampLongVector: public ::testing::TestWithParam< int >
//{
//    
//public:
//    //  Create an std and a bolt vector of requested size, and initialize all the elements to -1
//    HostampLongVector( ): stdInput( GetParam( ), -1 ), boltInput( GetParam( ), -1 )  {}
//
//protected:
...
protected:
    ...
    bolt::amp::device_vector< short > boltInput;
};
...
//    bolt::amp::device_vector< cl_long > boltInput;
//};
...
//BOLT_TEMPLATE_REGISTER_NEW_ITERATOR( bolt::amp::device_vector, int, characters);
...
TEST( CharPointer, Fill )
{
    ...
    bolt::amp::fill(dvs.begin(), dvs.end(),c_str ); 
...
TEST( AutomaticCharPointer, Fill )
{
    ...
    bolt::amp::fill(ctl, dvs.begin(), dvs.end(),c_str ); 
    for (int i = 0; i < size; ++i)
    { 
...
TEST (AutomaticsimpleTest, basicDataBoltAMPDevVectAutoConvertCheck)
{ 
    size_t size =10; 
    int iValue = 48; 
    union ieeeconvert
