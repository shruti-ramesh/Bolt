...
{
    {
        ...
        bolt::amp::device_vector< int > dvIndexVec( length );
        bolt::amp::device_vector< UDD2 > dvElementVec( length );
		...
		std::iota(dvIndexVec.begin(),   dvIndexVec.end(), 0);
		//std::iota(dvElementVec.begin(), dvElementVec.end(), t);
		bolt::amp::fill(dvElementVec.begin(), dvElementVec.end(),t);
...
{
    {
		...
		dv_trf_itr dv_trf_begin1 = bolt::amp::make_permutation_iterator(dvIn1Vec.begin(), dmap.end());
