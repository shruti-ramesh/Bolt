...
TEST( HostIntVector, For_each  )
{
    ...
    std::for_each(  stdInput.begin( ),  stdInput.end( ),  std::negate<int>() );
    bolt::amp::for_each( boltInput.begin( ), boltInput.end( ),  bolt::amp::negate<int>() );
...
TEST( DVIntVector, For_each_n  )
{
    ...
    std::for_each(  stdInput.begin( ),  stdInput.begin( ) + n, negative<int>()/*std::negate<int>()*/ );
    bolt::amp::for_each_n( boltInput.begin( ), n, negative<int>()/* bolt::amp::negate<int>()*/ );
...
TEST( DVIntVector, For_each  )
{
    ...
    std::for_each(  stdInput.begin( ),  stdInput.end( ), negative<int>()/*std::negate<int>()*/ );
    bolt::amp::for_each( boltInput.begin( ), boltInput.end( ), negative<int>()/* bolt::amp::negate<int>()*/ );
...
TEST( DVIntVector, OffsetForEach_n )
{
    ...
    std::for_each(  stdInput.begin( ) + offset,  stdInput.begin( ) + n, negative<int>()/*std::negate<int>()*/ );
    bolt::amp::for_each_n( boltInput.begin( ) + offset, n, negative<int>()/*bolt::amp::negate<int>()*/ );
...
TEST( DVIntVector, OffsetForEach )
{
    ...
    std::for_each(  stdInput.begin( ) + offset,  stdInput.end( ), negative<int>()/*std::negate<int>()*/ );
    bolt::amp::for_each( boltInput.begin( ) + offset, boltInput.end( ), negative<int>()/*bolt::amp::negate<int>()*/ );
...
TEST_P( ForEachIntegerVector, for_each_n )
{
    ...
    //  Calling the actual functions under test
    std::for_each( stdInput.begin(), stdInput.begin() + n, std::negate<int>());
    bolt::amp::for_each_n( boltInput.begin( ), n,  bolt::amp::negate<int>() );
...
{
    //  Calling the actual functions under test
    std::for_each( stdInput.begin( ), stdInput.end( ), [](float x){return x*x;} );
    bolt::amp::for_each( boltInput.begin( ), boltInput.end( ),  bolt::amp::square<float>() );
...
{
    //  Calling the actual functions under test
    std::for_each( stdInput.begin( ), stdInput.end( ), [](float x){return x*x*x;} );
    bolt::amp::for_each( boltInput.begin( ), boltInput.end( ),  bolt::amp::cube<float>() );
...
{
    //  Calling the actual functions under test
    std::for_each( stdInput.begin( ), stdInput.end( ), std::negate<double>() );
    bolt::amp::for_each( boltInput.begin( ), boltInput.end( ), bolt::amp::negate<double>() );
...
//No Compilation Error. But no Output with bolt::amp::for_each
...
//    }
//    std::for_each( input1.begin(), input1.end(), std::negate<int>());
//    bolt::amp::for_each(iter,iter2, std::negate<int>()/*bolt::amp::negate<int>()*/);
//
//	std::vector<int> output(iter,iter2);
//
//    cmpArrays( input1, output);
...
//
//    std::for_each( input1.begin(), input1.begin() + n, std::negate<int>());
//    bolt::amp::for_each_n(iter, n, std::negate<int>()/*bolt::amp::negate<int>()*/);
//
//	std::vector<int> output(iter,iter2);
//
//    cmpArrays( input1, output);
