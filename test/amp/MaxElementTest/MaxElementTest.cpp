...
REGISTER_TYPED_TEST_CASE_P( MaxEArrayTest, comp_Normal, comp_SerialNormal, comp_MultiCoreNormal, MultiCoreNormal);
...
INSTANTIATE_TEST_CASE_P( MaxERange, MaxEFloatVector, ::testing::Range( 1, 65535, 133 ) );
