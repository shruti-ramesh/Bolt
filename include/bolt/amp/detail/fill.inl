...
namespace detail {
            ...
            void fill_enqueue(const bolt::amp::control &ctl, const DVForwardIterator &first,
                const DVForwardIterator &last, const T & val)
            {
               ...
               concurrency::array_view<T,1> inputV (first.getContainer().getBuffer());
        ...
        */
            ...
            fill_pick_iterator(const bolt::amp::control &ctl,  const ForwardIterator &first,
                const ForwardIterator &last, const T & value)
            {
                ...
                else
                {
						...
						device_vector< Type, concurrency::array_view > range( first, last, false, ctl );
            ...
            fill_pick_iterator(const bolt::amp::control &ctl,  const DVForwardIterator &first,
            ...
            // fill no support
            template<typename ForwardIterator, typename T>
            void fill_detect_random_access( const bolt::amp::control &ctl, ForwardIterator first, ForwardIterator last,
        ...
        template< typename ForwardIterator, typename T >
        void fill( const bolt::amp::control &ctl,
        ...
        template<typename OutputIterator, typename Size, typename T>
        OutputIterator fill_n( const bolt::amp::control &ctl,
